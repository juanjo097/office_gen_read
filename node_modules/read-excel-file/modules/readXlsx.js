...
export default function readXlsx(contents, xml) {
  ...
  // Parse sheet data.
  var sheet = parseSheet(contents['xl/worksheets/sheet' + sheetId + '.xml'], xml, values, styles, properties, options);
...
function isDateTemplate(template) {
  ...
  for (var _iterator6 = tokens, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();;) {
    var _ref7;
